...
class TocResourceDumper
{
    ...
    protected function createHeadElement(DOMDocument $dom)
    {
    ...
    protected function createDocTitleElement(DOMDocument $dom)
    {
    ...
    protected function createNavMapElement(DOMDocument $document, Package $package)
    {
    ...
    protected function createNavPoint(DOMDocument $document, ManifestItem $item, &$index)
    {
